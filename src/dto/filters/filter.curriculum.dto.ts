...
export class CurriculumFilterDto extends BaseFilterParams {
  @ApiPropertyOptional({ description: 'Filter by name or code', required: false, example: 'Computer Science' })
  @IsOptional()
  @IsString()
  nameCode?: string;

  @ApiPropertyOptional({ description: 'Degree filter (e.g., BSc, MSc)', required: false, example: 'BSc' })
  @IsOptional()
  @IsString()
  degree?: string;
